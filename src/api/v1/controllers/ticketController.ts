...
import { getAllTickets, getOneTicket, createNewTicket } from "../servaces/ticketService";
...
//     let result = createNewTicket(id, title, description, createdAt, priority, status);
